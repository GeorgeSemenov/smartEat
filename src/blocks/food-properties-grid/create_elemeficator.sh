#!/bin/sh
parentName=food-properties-grid
...
end1
cat food-properties-grid.pug >> newFile.pug
mv -f newFile.pug  food-properties-grid.pug
...
end3
cat food-properties-grid.scss >> newFile.scss
mv -f newFile.scss food-properties-grid.scss
cd ${fileName}
