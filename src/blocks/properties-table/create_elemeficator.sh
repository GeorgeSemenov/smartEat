...
end1
cat properties-table.pug >> newFile.pug
mv -f newFile.pug  properties-table.pug
...
end3
cat properties-table.scss >> newFile.scss
mv -f newFile.scss properties-table.scss
cd ${fileName}
