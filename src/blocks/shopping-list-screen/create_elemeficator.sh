#!/bin/sh
parentName=shopping-list-screen
...
end1
cat shopping-list-screen.pug >> newFile.pug
mv -f newFile.pug  shopping-list-screen.pug
...
end3
cat shopping-list-screen.scss >> newFile.scss
mv -f newFile.scss shopping-list-screen.scss
cd ${fileName}
